...
public class B_switch1 {
	 ...
	 * case 값n : 실행코드;
	 * 
	 * dafault : 위에 값들이 모두 일치하지 않았을 때 실행하는 코드
	 */
	
	public static void main(String [] args) {
		Scanner sc = new Scanner(System.in);
		/*
		 * 정수를 입력받아 1일경우 빨간색입니다. 2일경우 파란색입니다. 3일경우 초록색입니다. 다른경우 모두 잘못입력하였습니다.
		 */
		...
		*/
		...
		/*
		 * 과일을 구매하는 프로그램을 작성
		 * 구매하고자하는 과일을 입력하면 그에맞는 가격이 출력되는 프로그램을 작성
		 * 
		...
		case "바나나" :
			...
			break;
		case "딸기" :
			System.out.println("딸기의 가격은 5000원 입니다. ");
			break;
		default:
			System.out.println("잘못입력하였습니다.");
		}
		...
		*/
		...
		case 3 :
			...
			break;
		case 4 :
			System.out.println("4월은 30일까지입니다.");
			break;
		case 5 :
		...
		case 12 :
			...
			break;
		default:
			System.out.println("입력하신 월은 없습니다.");
	}
	*/
