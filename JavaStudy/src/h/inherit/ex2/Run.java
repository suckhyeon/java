...
public class Run {
	...
	/*
	 * 상속 : 부모클래스의 필드와 메소드를 자식클래스에서 그대로 이어받아 사용하는 것
	 * (실제로 상속된 클래스를 통해서 객체생성시 부모클래스의 객체도 생성이 된다.)
	 * 
	 * 상속의 장점 : 적은 양의 코드로 새로운 클래스를 정의하고 사용할 수 있다.(생산성이 좋다.)
	 *            코드를 공통으로 관리하기 때문에 코드의 추가나 변경이 용이하다(유지보수성이 좋다)
	 *            
	 * 상속의 특징 : 클래스간의 다중상속 불가(부모는 하나다.)
	 * 			 부모클래스에 정의되어있는 protected필드는 자식클래스에서 직접 접근이 가능하다.(private는 불가)
	 * 			 자식객체는 부모클래스의 있는 메소드를 마치 내것처럼 호출할 수 있다.
	 * 
	...
	public static void main(String[] args) {
		...
		// 필드에는 int inch정보를 가지고잇고 information을 오버라이딩하여 기본 rpduct의 정보 +  inch정보 출력
		// tv생성 후 정보출력
		
		TV t = new TV("삼성", "s-100", "PC", 1000000, 27);
